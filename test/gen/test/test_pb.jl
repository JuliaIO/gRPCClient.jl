...
) = gRPCServiceClient{TestRequest, false, TestResponse, false}(
...
TestService_TestServerStreamRPC_Client(
	...
	max_send_message_length = 4*1024*1024,
	max_recieve_message_length = 4*1024*1024,
) = gRPCServiceClient{TestRequest, false, TestResponse, true}(
...
TestService_TestClientStreamRPC_Client(
	...
	max_send_message_length = 4*1024*1024,
	max_recieve_message_length = 4*1024*1024,
) = gRPCServiceClient{TestRequest, true, TestResponse, false}(
...
TestService_TestBidirectionalStreamRPC_Client(
	...
	max_send_message_length = 4*1024*1024,
	max_recieve_message_length = 4*1024*1024,
) = gRPCServiceClient{TestRequest, true, TestResponse, true}(
